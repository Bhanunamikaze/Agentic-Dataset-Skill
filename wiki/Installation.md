...
```powershell
powershell -ExecutionPolicy Bypass -File .\install.ps1 --online --target global
```
...
```powershell
powershell -ExecutionPolicy Bypass -File .\install.ps1 --online --ref v0.1.0 --target codex --force
```
